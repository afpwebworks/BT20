...
<cfcomponent name="BeanDefinition" 
	...
	<!--- support for 'isabstract' and 'parent' bean definitions --->	
	<cfset variables.instanceData.isabstract = false>
	...
	<!--- for adding parent bean support. We will first duplicate the parent bean definition with initFromParent, then
		 ...
		 * <li>Will always take isabstract, singleton, lazyInit from the given bean definition.
	...
	<cffunction name="isAbstract" access="public" output="false" returntype="boolean" 
				hint="Returns the 'isabstract' flag for the bean definition">
		<cfreturn variables.instanceData.isabstract />
	</cffunction>

	<cffunction name="setisabstract" access="public" output="false" returntype="void"  
				hint="I set the 'isabstract' flag for the bean definition">
		<cfargument name="isabstract" type="boolean" required="true"/>
		<cfset variables.instanceData.isabstract = arguments.isabstract />
	</cffunction>
